...
<div class="p-6">
    ...
    <!-- Welcome Card -->
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-6 text-white mb-8">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-2xl font-bold">Selamat Datang di Sistem Telemetri</h2>
                <p class="mt-1 text-blue-100">Kelola sistem telemetri dengan mudah dan efisien</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Data Telemetri</p>
                    <p class="text-2xl font-bold text-gray-900">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Sistem Aktif</p>
                    <p class="text-2xl font-bold text-gray-900">-</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Alert</p>
                    <p class="text-2xl font-bold text-gray-900">-</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <button class="flex items-center p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
                ...
                <span class="text-amber-700 font-medium">Lihat Data</span>
            </button>
            ...
            <button class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                ...
                <span class="text-purple-700 font-medium">Pengaturan</span>
            </button>
        </div>
    </div>
</div>
