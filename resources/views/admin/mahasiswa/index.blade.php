                    ...
                    <div class="lg:col-span-2">
                        <div class="flex gap-2">
                            ...
                            @if(request('search') || request('tahun_masuk') || request('status'))
                                <a href="{{ route('admin.mahasiswa.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" value="{{ $mhs->id }}" class="mahasiswa-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                        </td>
