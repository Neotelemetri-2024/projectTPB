                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" value="{{ $mk->id }}" class="matkul-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                        </td>
...
>
    <div class="grid gap-4 mb-4 grid-cols-2">
        ...
        <div>
            ...
            <input type="text" name="kurikulum" id="kurikulum" value="{{ old('kurikulum') }}" class="bg-gray-50 border {{ $errors->has('kurikulum') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5" placeholder="2020" required>
            @error('kurikulum')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-6 text-center">
                ...
                <form id="form-bulk-delete" action="{{ route('admin.mata-kuliah.bulk-destroy') ?? '#' }}" method="POST">
                    ...
                    <button data-modal-hide="modal-bulk-delete" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Tidak, batal</button>
                </form>
            </div>
        </div>
    </div>
