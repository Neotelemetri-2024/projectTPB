...
<div class="p-6">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.tahun-ajaran-matkul.store') }}" method="POST" class="space-y-6" id="createForm">
                @csrf
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                <label class="flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg cursor-pointer hover:bg-amber-50 hover:border-amber-300 transition-colors has-[:checked]:bg-amber-50 has-[:checked]:border-amber-500" id="label-dosen-same">
                                    <input type="radio"
                                        name="dosenOption"
                                        value="same"
                                        id="dosen-same"
                                ...
                                <label class="flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg cursor-pointer hover:bg-amber-50 hover:border-amber-300 transition-colors has-[:checked]:bg-amber-50 has-[:checked]:border-amber-500" id="label-dosen-different">
                                    <input type="radio"
                                        name="dosenOption"
                                        value="different"
                                        id="dosen-different"
                ...
                {{-- STEP 3: Input Kelas --}}
                {{-- ============================== --}}
                <div id="step-kelas-wrapper" class="hidden">
                    <h3 class="text-sm font-semibold text-gray-800 mb-3 flex items-center">
