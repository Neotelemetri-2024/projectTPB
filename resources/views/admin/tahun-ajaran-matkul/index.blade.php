            ...
            <form method="GET" action="{{ route('admin.tahun-ajaran-matkul.index') }}">
                ...
                <div class="flex gap-4 items-end">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            <input type="text" id="search-input" name="search" autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5" placeholder="Cari nama atau kode mata kuliah..." value="{{ request('search') }}">
