                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <!-- Tombol Hapus -->
                                <button type="button" data-modal-target="modal-confirm-hapus-{{ $ta->id }}" data-modal-toggle="modal-confirm-hapus-{{ $ta->id }}" class="inline-flex items-center justify-center bg-red-600 hover:bg-red-700 text-white p-1.5 rounded-md" title="Hapus">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
