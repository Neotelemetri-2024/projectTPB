        ...
        <div class="relative bg-white rounded-lg shadow-xl animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <form action="{{ $action }}" method="POST" class="p-4 md:p-5">
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" class="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center:bg-purple-700:ring-purple-800 transition-colors duration-200">
