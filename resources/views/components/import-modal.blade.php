    ...
    <div class="modal-box p-0 bg-white rounded-lg shadow-xl max-w-md" data-modal-content>
        ...
        <form action="{{ $action }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 rounded-lg text-sm font-medium px-5 py-2.5 text-center transition-colors duration-200 inline-flex items-center justify-center">
