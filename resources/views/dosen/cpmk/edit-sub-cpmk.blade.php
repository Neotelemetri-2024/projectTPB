...
@section('title', 'Edit Sub-CPMK - ' . $cpmk->kodeCpmk)
...
<div class="p-4 md:p-6 space-y-4">
    ...
    <nav>
        <ol class="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li class="text-gray-900 font-medium">Edit Sub-CPMK</li>
        </ol>
    </nav>
    ...
    <div class="bg-white border border-gray-200 rounded-xl">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Edit Sub-CPMK</h1>
        ...
        <div class="p-6 border-b border-gray-200 bg-gray-50">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Parent CPMK</h2>
        ...
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">Edit Informasi Sub-CPMK</h2>
            <p class="text-sm text-gray-600 mt-1">Perbarui informasi sub-CPMK {{ $cpmk->kodeCpmk }}</p>
        </div>

        <form action="{{ route('dosen.cpmk.sub-cpmk.update', [$tahunAjaranMatkul->id, $cpmk->id]) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
