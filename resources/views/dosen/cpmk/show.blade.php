    ...
    <div class="bg-white border border-gray-200 rounded-xl">
        <div class="p-6 border-b border-gray-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('dosen.cpmk.detail', [$tahunAjaranMatkul->id, $cpmk->id]) }}"
                                           class="inline-flex items-center justify-center bg-amber-600 hover:bg-amber-700 text-white p-1.5 rounded-md" title="Lihat Detail">
                                        ...
                                        <button type="button" class="delete-btn inline-flex items-center justify-center bg-red-600 hover:bg-red-700 text-white p-1.5 rounded-md" title="Hapus"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-medium text-gray-900">
                                        {{ $subCpmk->kodeCpmk }}
                                        <span class="ml-1 text-xs text-gray-500">(Sub)</span>
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <a href="{{ route('dosen.cpmk.sub-cpmk.edit', [$tahunAjaranMatkul->id, $subCpmk->id]) }}"
                                           class="inline-flex items-center justify-center bg-amber-600 hover:bg-amber-700 text-white p-1.5 rounded-md" title="Edit Sub-CPMK">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                ...
                @if($editBobot)
                <button type="submit" id="submit-bobot-cpmk" class="w-full sm:w-auto px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-gray-400 cursor-not-allowed" disabled>
        ...
        <div class="mt-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">Total Bobot CPMK</h3>
                </div>
        ...
        modalForm.addEventListener('submit', function(e) {
            if (currentDeleteType === 'bulk' && selectedIds.length > 0) {
                ...
                if (typeof setButtonLoading === 'function') {
                    setButtonLoading(submitBtn, true, 'Menghapus...');
                } else if (submitBtn) {
