        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($totalMahasiswa) }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($totalDosen) }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($totalMataKuliah) }}</p>
                    <p class="text-xs text-purple-600 mt-1">{{ number_format($activeCourses) }} aktif semester ini</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="text-xl font-bold text-gray-900">{{ number_format($totalCPL) }}</span>
                        <span class="text-gray-400">|</span>
                        <span class="text-xl font-bold text-gray-900">{{ number_format($totalCPMK) }}</span>
                    </div>
